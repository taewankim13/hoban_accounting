...
def chat_with_claude(messages: list, current_form: dict = None) -> dict:
...
def process_chat(message: str, history: list = None, current_form: dict = None) -> dict:
    ...
    if HAS_CLAUDE:
        ...
        return chat_with_claude(messages, current_form)
    else:
        # 로컬 강화 파서
